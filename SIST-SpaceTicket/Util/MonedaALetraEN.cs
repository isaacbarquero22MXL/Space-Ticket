...
{
    public class MonedaEnLetrasEN
    {
        private static String[] UNIDADES = { "", "one ", "two ", "three ", "four ", "five ", "six ", "seven ", "eight ", "nine " };
        private static String[] DECENAS = {"ten ", "eleven ", "twelve ", "thirteen ", "fourteen ", "fifteen ", "sixteen ",
        "seventeen ", "eighteen ", "nineteen ", "twenty ", "thirty ", "forty ",
        "fifty ", "sixty ", "seventy ", "eighty ", "ninety "};
        private static String[] CENTENAS = {"", "one hundred ", "two hundred ", "three hundred ", "four hundred ", "five hundred ", "six hundred ",
        "seven hundred ", "eight hundred ", "nine hundred "};

        private static Regex r;

        public static String Convertir(String numero, bool mayusculas, string moneda, string MN)
        {
            ...
            if (mc.Count > 0)
            {
                ...
                parte_decimal = moneda + " and " + getDecenas(Num[1].ToString()) + " " + MN;
        ...
        {// 99                        
            ...
            {//para 20...99
                ...
                {
                    return DECENAS[int.Parse(num.Substring(0, 1)) + 8] + "and " + u;
                }
            }
            else
        ...
        {// 999 999
            ...
            {
                n = getCentenas(m);
                return n + "thousand " + getCentenas(c);
            }
            else
            {
        ...
        { //000 000 000        
            ...
            if (millon.Length > 1)
            {
                n = getCentenas(millon) + "millions ";
            }
            else
            {
                n = getUnidades(millon) + "million ";
            }

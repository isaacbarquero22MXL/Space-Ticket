...
public class QuickResponse
{
    ...
    //crear un codigo QR mediante este link API
    public static String GenerateQRCodeAPI(String ID)
    {
        return "http://api.qrserver.com/v1/create-qr-code/?data=" + ID + "&size=200x200";
    }
